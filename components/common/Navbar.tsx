...
export default function Navbar() {
  ...
  { href: `/${locale}/user/courses`, label: t('common.courses') }, // ضيف user/
              ...
              <>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center space-x-2 rtl:space-x-reverse p-2 hover:bg-neutral-100 rounded-lg transition-colors"
                  >
